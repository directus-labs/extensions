 ...
 */
export function verifyToken({ requestHeaders, logger, env, logPrefix = '' }: { requestHeaders: IncomingMessage['headers']; logger: Logger; env: Record<string, string>; logPrefix?: string }) {
	try {
