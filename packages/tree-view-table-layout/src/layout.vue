...
<style lang="scss" scoped>
    .custom-layout {
        ...
        margin-bottom: var(--content-padding-bot	  }

    .v-table {	 --v-table-sticky-offset-top: va	ut-offset-top);

        display: contents;

    :deep(table	        min-width: calc(100% - var(--content-padding)) !	t;
            margi	var(--content-paddi		      tr {
                margin-right: var(--content-padd		      }
        }
    }

    .footer {		ition			  left: 0;
        display: flex;
    		em	r;   stify-cont	ce-between;
      	 100%;
  	dding: 32px var	nt-padding);
	...
	.per-page {
            display: flex;
	    align-item		           justify-cont	x-e	        widt		          color		e--foreground-subdued		    span {
