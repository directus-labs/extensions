<template>
	<div ref="interfaceContainer" class="whiteboard-container" :class="{'fullscreen': fullscreen}">
		<div ref="wrapper" class="canvas-wrapper">
			<canvas ref="container" height="400"></canvas>
		</div>
						...
						>
							<template #activator="{ toggle }">
								<v-button  
									...
									@click="toggle"
								>
									<v-icon name="format_size"></v-icon>
									<svg xmlns="http://www.w3.org/2000/svg" class="arrow" viewBox="0 0 24 24"><path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" /></svg>
								</v-button>
							</template>
							<VList>
						...
						>
							<template #activator="{ toggle }">
								<v-button  
									...
									@click="toggle"
								>
									<v-icon :name="(wb.textAlign == 'left' ? 'format_align_left' : (wb.textAlign == 'center' ? 'format_align_center' : 'format_align_right'))"></v-icon>
									<svg xmlns="http://www.w3.org/2000/svg" class="arrow" viewBox="0 0 24 24"><path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" /></svg>
								</v-button>
							</template>
							<VList>
								<VListItem clickable :active="wb.textAlign == 'left'" @click="wb.textAlign = 'left'">
									<VListItemIcon>
										<v-icon name="format_align_left"></v-icon>
									</VListItemIcon>
									<VListItemContent>
										Left
									</VListItemContent>
								...
								<VListItem clickable :active="wb.textAlign == 'center'" @click="wb.textAlign = 'center'">
									<VListItemIcon>
										<v-icon name="format_align_center"></v-icon>
									</VListItemIcon>
									<VListItemContent>
										Center
									</VListItemContent>
								...
								<VListItem clickable :active="wb.textAlign == 'right'" @click="wb.textAlign = 'right'">
									<VListItemIcon>
										<v-icon name="format_align_right"></v-icon>
									</VListItemIcon>
									<VListItemContent>
										Right
									</VListItemContent>
...
<script lang="ts" setup>
	...
	const toggleTool = (tool:string, image?:any) => {
	...
	onMounted(() => {
		...
		wb.value.canvas.on('edit:save', function() {
