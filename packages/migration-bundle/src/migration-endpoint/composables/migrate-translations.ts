...
const migrateTranslations = async ({ res, client, translations, dry_run = false }: { res: any, client: RestClient<Schema>, translations: Translation[] | null, dry_run: boolean }): Promise<{ response: string, name: string } | DirectusError> => {
