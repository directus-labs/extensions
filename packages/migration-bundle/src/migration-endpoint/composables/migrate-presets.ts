...
const migratePresets = async ({ res, client, presets, dry_run = false }: { res: any, client: RestClient<Schema>, presets: Preset[] | null, dry_run: boolean }): Promise<{ response: string, name: string } | DirectusError> => {
