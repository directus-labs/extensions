...
import type { DirectusError, UserCollectionItems, UserCollectionItem } from '../../types/extension';
import { Schema } from '../api';
import { createItems, updateItemsBatch, updateSingleton, readItems } from '@directus/sdk';
...
const getExistingPrimaryKeys = async (res: any, client: any, collection: string, primaryKeyField: string): Promise<Set<any>> => {
...
const uploadBatch = async (res: any, client: any, collection: string, batch: Item[], method: Function, dry_run: boolean) => {
  try {
    if(!dry_run){
...
const loadFullData = async (res: any, client: any, fullData: UserCollectionItems[], dry_run: boolean) => {
...
const loadSingletons = async (res: any, client: any, singleton: UserCollectionItem[], dry_run: boolean) => {
