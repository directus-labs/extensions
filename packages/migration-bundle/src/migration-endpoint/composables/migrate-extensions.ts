...
const installExtension = async (extension: any, client: any): Promise<void> => {
...
const migrateExtensions = async ({ res, client, extensions, dry_run = false }: { res: any, client: RestClient<Schema>, extensions: Extension[] | null, dry_run: boolean }): Promise<{ response: string, name: string } | DirectusError> => {
