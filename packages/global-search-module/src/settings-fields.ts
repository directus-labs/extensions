export const fields = [
  ...
  },
  {
    ...
    meta: {
      interface: 'input',
      width: 'half',
      note: 'The number of recent searches to remember. Searches are stored locally in your browser and not in the database. Set to 0 to disable. Set to -1 to remember all searches.'
    }
  },
  {
