...
import { defaultSettings, SearchConfigType } from "./types";
    ...
    <main class="container">
      ...
      <section v-else-if="globalSearchSettingsField">
        <v-info icon="block" title="Settings Field Error" type="danger" center>
          <p>
            There's an error with the structure of the global search settings.
          </p>
          <v-button
      ...
      <section v-else-if="!globalSearchSettingsField">
        ...
        >
          <p>
            The global search settings field is missing from Directus project
            settings.
          </p>
          <v-button
            kind="primary"
